<?php
/**
 * AdjeminPay Standard Payment Gateway.
 *
 * Plugin Name: AdjeminPay
 * Plugin URI: http://business.adjemin.com/
...
define( 'ADJEMINPAY_VERSION', '2.0.0' );
...
function deactivate_adjeminpay(){
    ...
    // $this->custom_post_type();
    // flush rewrite rules
    // delete_option('adp_app_id');
    // delete_option('adp_app_apikey');
    flush_rewrite_rules();
}
...
function adjeminpay_init() {
    ...
    class WC_Gateway_Adjeminpay extends WC_Payment_Gateway
    {
        ...
        public function __construct() {
            ...
            $this->seller_username       = $this->get_option( 'seller_username' );
        ...
        public function init_form_fields() {
            $this->form_fields = apply_filters('wc_offline_form_fields',array(
                ...
                'seller_username' => array(
                    'title'       => __( 'Username', 'adjeminpay' ),
                    'type'        => 'text',
                    'description' => __( 'Votre username', 'adjeminpay' )
                ),
                'debug' => array(
